								...
								<div class="form-inline">
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<thead>
											<tr class="filters">
												<th>&nbsp;</th>
												<th><input type="text" class="form-control" name="filter_category" value="<?php echo $filter['name'] ? clean_output($filter['name']) : ''; ?>" /></th>
												<th>
												<?php if($pages){ ?>
										...
										<?php foreach($categories as $category){ ?>
											<tr>
												<td><input type="checkbox" name="category_id[]" value="<?php echo $category['category_id']; ?>" /></td>
												<td><?php echo clean_output($category['name']); ?></td>
												<td><a href="<?php echo $category['page_url'] ? format_page_url($category['page_url']) : base_url(); ?>" target="_blank"><?php echo clean_output($category['page'])?></a></td>
												 <td>
												 <a href="<?php echo $category['href_edit']; ?>" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i> <?php echo $btn_edit_text; ?></a>
												 <a href="<?php echo $category['href_links']; ?>" class="btn btn-info"><i class="fa fa-pencil" aria-hidden="true"></i> <?php echo $btn_link_view_text; ?></a>
												 </td>
											</tr>
										<?php } ?>
										<?php } else { ?>
