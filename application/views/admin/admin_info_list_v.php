									...
									<table class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												...
												<th><?php echo $column_description_text; ?></th>
												<th><?php echo $column_menu_title_text; ?></th>
										...
										<thead>
											<tr class="filters">
												...
												<th><input type="text" class="form-control" name="filter_menu" value="<?php echo $filter['menu_title'] ? clean_output($filter['menu_title']) : ''; ?>" /></th>
												<th>
										...
										<?php foreach($info_pages as $info_page){ ?>
											<tr>
												<td><input type="checkbox" name="info_id[]" value="<?php echo $info_page['info_id']; ?>" /></td>
												
												<td><?php echo clean_output($info_page['title']); ?></td>
												<td><?php echo clean_output($info_page['description']); ?></td>
												<td><?php echo clean_output($info_page['menu_title']); ?></td>

												 <td>
												 <a href="<?php echo $info_page['href_edit']; ?>" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i> <?php echo $btn_edit_text; ?></a>
												 </td>
											</tr>
										<?php } ?>
										<?php } else { ?>
			...
			function filter() {
				...
				var filter_menu = $('select[name=\'filter_menu\']').val();
				if (filter_menu) {
					url += '&filter_member=' + encodeURIComponent(filter_menu);
				}	
