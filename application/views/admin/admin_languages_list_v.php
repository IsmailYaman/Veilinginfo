...
<input type="hidden" name="token" value="<?php echo $token; ?>" />
									...
									<table class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												...
												<th><?php echo $column_language_text; ?></th>
												<th><?php echo $column_machine_name_text; ?></th>
										...
										<thead>
											<tr class="filters">
												...
												<th><input type="text" class="form-control" name="filter_machine_name" value="<?php echo $filter['machine_name'] ? clean_output($filter['machine_name']) : ''; ?>" /></th>
												<th>
										...
										<?php foreach($languages as $language){ ?>
											<tr>
												<td><input type="checkbox" name="language_id[]" value="<?php echo $language['language_id']; ?>" /></td>
												<td><?php echo clean_output($language['name']); ?></td>
												<td><?php echo clean_output($language['machine_name']); ?></td>
												 <td>
												 <a href="<?php echo $language['href_edit']; ?>" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i> <?php echo $btn_edit_text; ?></a>
												 </td>
											</tr>
										<?php } ?>
										<?php } else { ?>
			...
			function filter() {
				...
				var filter_machine_name = $('input[name=\'filter_machine_name\']').val();
				if (filter_machine_name) {
					url += '&filter_machine_name=' + encodeURIComponent(filter_machine_name);
				}
