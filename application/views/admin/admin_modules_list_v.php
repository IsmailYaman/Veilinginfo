								...
								<div class="form-inline">
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<?php foreach($modules as $module){ ?>
											<tr>
												<td><input type="checkbox" name="module_id[]" value="<?php echo $module['module_id']; ?>" /></td>
												<td><?php echo clean_output($module['name']); ?></td>
												<td><?php echo clean_output($module['machine_name']); ?></td>
												 <td>
												 <a href="<?php echo $module['href_edit']; ?>" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i> <?php echo $btn_edit_text; ?></a>
												 </td>
											</tr>
										<?php } ?>
										<?php } else { ?>
