         <div class="row ">
                  <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
					...
					<?php } ?>
                        ...
                        <strong><?php echo $string_reset_password; ?></strong>  
                            </div>
                            <div class="panel-body">
                                <form role="form" action="" method="post">
                                     ...
                                     <div class="form-group input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="<?php echo $input_email_text; ?>" name="r_email" autofocus required/>
                                        </div>
                                     
                                     <button class="btn btn-primary "><?php echo $btn_reset; ?></button>
                                    </form>
                            </div>
